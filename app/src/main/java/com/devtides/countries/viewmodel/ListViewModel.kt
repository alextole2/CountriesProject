...
const val TAG = "CountriesProject"
...
class ListViewModel : ViewModel() {
    ...
    init {
        countriesService = DaggerApplicationComponent.create().getCountriesService()
        Log.d(TAG, "CountriesServer injected $countriesService")
    }
